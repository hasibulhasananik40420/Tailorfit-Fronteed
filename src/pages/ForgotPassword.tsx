          ...
          <div className="2xl:p-[50px] lg:p-[30px] flex justify-center items-center">
            <div className="2xl:w-[710px] lg:w-[710px] 2xl:h-[392px] lg:h-[392px] rounded-[10px] border-[1px] border-[#E5E5E5] p-[70px] 2xl:mt-[150px] lg:mt-[50px]">
              ...
              <form className="mt-[30px]">
                <div className="flex gap-[30px] items-center">
                  <div className="flex items-center gap-[10px]">
                    <input
                      ...
                      type="radio"
                      name="radioGroup" // Set the name for radio buttons in the same group
                      id="radioButton"
                      checked={isChecked}
                    ...
                    <label
                      htmlFor="radioButton"
                      className={` w-[20px] h-[20px] rounded-full border-[2px] border-gray-400 bg-white flex items-center justify-center cursor-pointer ${
                        isChecked ? "border-[#F00C89]" : ""
                      }`}
                    >
                      {isChecked && (
                    ...
                    <p className="text-[#666] text-[18px font-Poppins font-normal leading-[23.4px]">
                      Your Email{" "}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-[10px]">
                    <input
                      className="size-[20px] appearance-none"
                      type="radio"
                      name="radioGroup" // Set the name for Phone buttons in the same group
                      id="PhoneButton"
                      checked={isPhone}
                ...
                <p className="mt-[30px] text-[#888] text-[18px font-Poppins font-normal leading-[23.4px]">
                  We will send the OTP in your email{" "}
                  <span className="text-secondaryColor">example@email.com</span>
                </p>
